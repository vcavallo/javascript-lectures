$(document).ready(function(){
	...
	*/
	...
	//What if we just want to just get JSON from a remote server and pull to our local page, or to another remote file and use it as is?
	//Then we can use:
	
	/*---------- $.getJSON() ----------
	Load JSON-encoded data from the server using a GET HTTP request. More at: http://api.jquery.com/jQuery.getJSON/
	See next Exercise.
	*/
